package com.elasticonsulting.integration.esawssigning.v1;
...
public class AWSV4Auth {
	...
	private String prepareCanonicalRequest() {
		...
		/*
		 * Step 1.2 Add the canonical URI parameter, followed by a newline
		 * character.
		 */
		...
		/*
		 * Step 1.3 Add the canonical query string, followed by a newline
		 * character.
		 */
		...
		if (awsHeaders != null && !awsHeaders.isEmpty()) {
			...
			/*
			 * Note: Each individual header is followed by a newline character,
			 * meaning the complete list ends with a newline character.
			 */
			canonicalURL.append("\n");
		} else {
			canonicalURL.append("\n");
		...
		strSignedHeader = signedHeaders.substring(0, signedHeaders.length() - 1); // Remove
																					// last
																					// ";"
		canonicalURL.append(strSignedHeader).append("\n");

		/*
		 * Step 1.6 Use a hash (digest) function like SHA256 to create a hashed
		 * value from the payload in the body of the HTTP or HTTPS.
		 */
	...
	private String prepareStringToSign(String canonicalURL) {
		...
		/*
		 * Step 2.1 Start with the algorithm designation, followed by a newline
		 * character.
		 */
		stringToSign = HMACAlgorithm + "\n";

		/*
		 * Step 2.2 Append the request date value, followed by a newline
		 * character.
		 */
		stringToSign += xAmzDate + "\n";

		/*
		 * Step 2.3 Append the credential scope value, followed by a newline
		 * character.
		 */
		stringToSign += currentDate + "/" + regionName + "/" + serviceName + "/" + aws4Request + "\n";

		/*
		 * Step 2.4 Append the hash of the canonical request that you created in
	 ...
	 * @return
	 * @throws Exception
	 * @reference: http://docs.aws.amazon.com/general/latest/gr/signature-v4-
	 *             examples.html#signature-v4-examples-java
	 */
	...
	/**
	 * Using {@link URLEncoder#encode(java.lang.String, java.lang.String) }
	 * instead of {@link URLEncoder#encode(java.lang.String) }
	 * 
	 * @param param
	 * @return
	 */
